...
function CreateEmployeeComponent ()  {
    ...
    const saveEmployee = (e) => {
        ...
        EmployeeService.createEmployee(employee)
          .then((res) => {
            // Show the alert after successfully saving the employee
            alert("Employee " + employee.firstName + " " + employee.lastName + " saved successfully");
                        ...
                        <div >
                            <form onSubmit={saveEmployee}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type='date' placeholder="Enter DOB YYYY-MM-DD" name="dob" className="form-control"
                                ...
                                <div className="form-group">
                                    ...
                                    <select name="dept" className="form-control" placeholder="Enter City"
                                ...
                                <div className="form-group">
                                    ...
                                    <input placeholder="Enter Phone No" name="phone" className="form-control"
